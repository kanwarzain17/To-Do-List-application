...
def update_task():
    ...
    try:
        ...
        new_task = simpledialog.askstring("Update Task", "Update the selected task:", initialvalue=old_task)
        if new_task:
            listbox_tasks.delete(index)
...
def main():
    ...
    button_clear_task = tk.Button(root, text="Clear All Task", command=clear_task)
    button_clear_task.pack(side=tk.LEFT, padx=5)
